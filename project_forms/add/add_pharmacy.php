...
<head>
    ...
    <style>
        ...
        form.pharmacy-form {
            ...
            width: 360px;
            align-items: center;
            background: linear-gradient(176deg, rgb(195 114 37), #ffa900);
        }
...
<body>
    <form action="../view/view_pharmacy.php" method="GET">
        <input type="submit" value="View Pharmacy Table">
    </form>
    <form class="pharmacy-form" action="../process/process_pharmacy.php" method="POST">
